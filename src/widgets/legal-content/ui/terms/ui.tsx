  ...
  return (
    <div className={styles.content}>
      ...
      <ul>
        ...
        <li>
          <strong>“User Account”</strong> shall mean the account created by the
          End-user in order to use the online platform and the Virtual Asset
        ...
        <li>
          <strong>“Virtual Asset Buy Service”</strong> shall mean the execution
          of an exchange transaction provided by RIDM whereby the End-user sends
          Fiat Currency and receives Virtual Assets at an agreed purchase price.
        </li>{" "}
        <li>
          <strong>“Virtual Asset Sell Service”</strong> shall mean the execution
          of an exchange transaction provided by RIDM whereby the End-user sends
          Virtual Assets and receives Fiat Currency at an agreed purchase price.
        </li>{" "}
        <li>
        ...
        <li>
          <strong>“Virtual Asset Services”</strong> shall mean Virtual Asset Buy
          Service, Virtual Asset Sell Service, Virtual Asset Send Service and
          Custodial Wallet Service under these Terms of Service.
        </li>
      </ul>
      <div className={styles.divider} />
      ...
      <ul>
        ...
        <li>
          Further, RIDM reserves the right to cancel, suspend or terminate your
          use of the Platform or your User Account at any time without notice if
          you do not comply with these Terms of Service.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          In order to access the Virtual Asset Buy Service on the Platform, you
          need to dispose of a valid Payment Method supported on the Platform as
          described in section 6 of these Terms of Service. When using the
          Virtual Asset Buy Service on the Platform, you need to select the
          amount and the type of Virtual Asset that you wish to buy with Fiat
          Currency, the Platform will disclose the exchange rate of your
          purchase before executing the transaction. Once the transaction is
          completed, you will receive the purchased Virtual Asset on your
          Custodial Wallet available in your User Account.
        </li>
        <li>
          In order to access the Virtual Asset Sell Service on the Platform, you
          need to dispose of a Custodial Wallet in your User Account with an
        ...
        <li>
          In order to access the Virtual Asset Send Service on the Platform, you
          need to dispose of a Custodial Wallet in your User Account with an
        ...
        <li>
          The Platform may impose transaction limits to your use of the Virtual
          Asset Services, including but not limited to:
        </li>
        <ul>
        ...
        <li>
          End-users acknowledge that transactions may be delayed or rejected due
          to compliance verifications by RIDM.
        </li>
      </ul>
      <div className={styles.divider} />
      <h2>Supported Virtual Assets</h2>
      <div className={styles.divider} />
      <ul>
        <li>
      ...
      <ul>
        ...
        <li>
          End-users acknowledge and accept that RIDM does not issue refunds for
          any Virtual Asset transactions, including but not limited to:
        </li>
        <ul>
        ...
        <li>
          Blockchain transactions are executed by decentralized networks and are
          outside the control of the RIDM. End-users are solely responsible for
          verifying and confirming the accuracy of all transaction details
          before execution.
        </li>
      </ul>
      <div className={styles.divider} />
      ...
      <ul>
        <li>
          The Platform is provided on an "as-is" and "as-available" basis. While
          RIDM endeavors to maintain continuous operation of the Platform,
      ...
      <div className={styles.divider} />
      <h2>RISK DISCLOSURE AND DISCLAIMERS</h2>
      <div className={styles.divider} />
      <ul>
        <li>
      ...
      <ul>
        <li>
          These Terms of Service shall remain in force and effect as long as the
          End-user maintains an active User Account on the Platform.
        </li>
        <li>
        ...
        <li>
          RIDM reserves the right to terminate these Terms of Service and close
          the User’s account at its sole discretion, with or without prior
          notice, in the following circumstances:
        </li>
        <ul>
          <li>
            Breach of these Terms of Service or any other applicable policies by
            the End-user;
          </li>
          <li>
          ...
          <li>
            Suspicion of fraudulent, illegal, or unauthorized activities related
            to the User Account;
          </li>
          <li>Abuse, misuse, or circumvention of Platform functionalities;</li>
          <li>Inactivity of the account for a prolonged period;</li>
          <li>
            Force majeure events or circumstances requiring the discontinuation
            of Platform or the Virtual Asset Services;
          </li>
          <li>
        ...
        <li>
          Upon termination, the User’s access to the Platform, User Account, and
          related Virtual Asset Services shall be permanently revoked. Any
        ...
        <li>
          Termination of these Terms of Service does not relieve either party of
          any outstanding obligations incurred before the termination date,
          including:
        </li>
        <ul>
          ...
          <li>
            Compliance with post-termination obligations under applicable laws,
            including data retention rules.
          </li>
        </ul>
        <li>
        ...
        <ul>
          <li>Liability, indemnification, and dispute resolution clauses;</li>
